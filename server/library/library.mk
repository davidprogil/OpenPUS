...
include $(LIBRARY_COMPONENT_FOLDER)/CcsdsUtils.mk
include $(LIBRARY_COMPONENT_FOLDER)/PusUtils.mk
...
LIBRARY_COMPONENT_INCLUDES_PATHS= \
						...
						$(CCDSDSUTILS_INCLUDES_PATHS) \
						$(PUSUTILS_INCLUDES_PATHS) \
